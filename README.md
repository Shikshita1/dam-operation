...
Firstly, understanding the operating rule of the dam was a bit challenging. After understanding, we had to implement the rule in our code. Operating rule was adapted from P. Qin et al.(2020). 
